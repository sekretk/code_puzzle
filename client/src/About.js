    ...
    return (
        <>
            ...
            <p className="rules">
                ...
                На основе фидбэка от 5 минутного тестирования нужно добавить, что вы ВСЕГДА получаете случайное задание - так что жмите "Далее" если уже решали. И при старте закомментированы случайные элементы - не позволяйте этому выбору повлиять на вас!<br/>
